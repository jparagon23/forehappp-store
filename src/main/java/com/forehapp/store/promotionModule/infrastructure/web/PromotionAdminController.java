...
public class PromotionAdminController {
    ...
    public CouponResponse updateCoupon(
        ...
        return promotionModuleService.adminUpdateCoupon(Long.parseLong(userId), couponId, dto);
    }
    ...
    public CouponResponse deactivateCoupon(
            @AuthenticationPrincipal String userId,
            @PathVariable Long couponId) {
        return promotionModuleService.adminDeactivateCoupon(Long.parseLong(userId), couponId);
    }
}
