...
public class ReportSellerController {
    ...
    public ResponseEntity<BusinessSummaryResponse> getMySummary(
        ...
        return ResponseEntity.ok(sellerReportService.getMySummary(storeId, Long.parseLong(userId), from, to));
    }
    ...
    public ResponseEntity<List<TopProductResponse>> getMyTopProducts(
        ...
        return ResponseEntity.ok(sellerReportService.getMyTopProducts(storeId, Long.parseLong(userId), from, to, limit));
    }
}
